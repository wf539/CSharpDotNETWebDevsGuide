...
s = s & "    <arithmeticMean xmlns=""urn:schemas-syngress-com-soap"">" & vbCrLf
s = s & "      <arrayInput>" & vbCrLf
s = s & "        <int>1</int>" & vbCrLf
s = s & "        <int>2</int>" & vbCrLf
s = s & "        <int>7</int>" & vbCrLf
s = s & "      </arrayInput>" & vbCrLf
s = s & "    </arithmeticMean>" & vbCrLf
s = s & "  </soap:Body>" & vbCrLf
