...
namespace ListClient
{
	public class Form1 : System.Windows.Forms.Form
	{
		...
		public Form1()
		{
			...
			RemotingConfiguration.RegisterWellKnownServiceType(typeof(CompanyLists ), "CompanyLists", WellKnownObjectMode.Singleton);
		...
		{
			CompanyLists cLst = (CompanyLists)Activator.GetObject(typeof(CompanyLists),"http://localhost:8080/CompanyLists",WellKnownObjectMode.Singleton);
